      ...
      <div className="min-h-screen p-8">
        <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div className="text-center space-y-4">
            ...
            <p className="text-xl text-gray-400">{site.description}</p>
          </div>
          ...
          <div
            className={`grid ${
              site.agentType === "gamedev" ? "grid-cols-1" : "grid-cols-4"
            } gap-6`}
          >
            ...
            <div
              className={`${
                site.agentType === "gamedev" ? "col-span-1" : "col-span-3"
              } h-[800px] bg-terminal-black border border-cyber-blue/30 rounded-lg overflow-hidden`}
            >
              <Browser
                html={currentHtml}
                pages={site.pages}
